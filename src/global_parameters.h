...
constexpr float LINEAR_SPEED_SLIDER_MINIMUM = 0.1f;
...
constexpr float ANGLE_SPEED_SLIDER_MINIMUM = 0.005f;
constexpr float ANGLE_SPEED_SLIDER_MAXIMUM = 0.05f;
constexpr float ANGLE_SPEED_SLIDER_STEP = 0.001f;
